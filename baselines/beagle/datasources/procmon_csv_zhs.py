...
from beagle.transformers.procmon_transformer_zhs import ProcmonTransformerZHS

class ProcmonCSVZHS(DataSource):
    ...
    transformers = [ProcmonTransformerZHS]  # The transformer this will send events to
