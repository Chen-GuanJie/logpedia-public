...
if __name__ == '__main__':
    ...
    for file in os.listdir("ATLAS/paper_experiments/S1/testing_logs"):
        print("parsing: testing_logs/" + file)
        preprocessing_lines = []
        path = os.path.join("ATLAS/paper_experiments/S1/testing_logs", file + "/logs")

        output_file = "ATLAS/paper_experiments/S1/output_test/testing_preprocessed_logs_" + file
