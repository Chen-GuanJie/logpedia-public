...
if __name__ == '__main__':
	...
	if DO_TRAINING:
		...
		if load_nonsampling:
				...
				nonsampling_in = open("ATLAS/paper_experiments/S1/resampling/nonsampling.json")
			...
			resampling_in = open("ATLAS/paper_experiments/S1/resampling/resampling.json")
			...
			undersampling_in = open("ATLAS/paper_experiments/S1/resampling/undersampling.json")
			...
			if not load_nonsampling:
				...
				if os.path.exists("ATLAS/paper_experiments/S1/resampling/nonsampling.json"):
					os.remove("ATLAS/paper_experiments/S1/resampling/nonsampling.json")
					
				nonsampling_out = open("ATLAS/paper_experiments/S1/resampling/nonsampling.json", 'w')
			...
			if count_y_1 < count_y_0:
				...
				if not load_undersampling:
					...
					if os.path.exists("ATLAS/paper_experiments/S1/resampling/undersampling.json"):
						os.remove("ATLAS/paper_experiments/S1/resampling/undersampling.json")

					undersampling_out = open("ATLAS/paper_experiments/S1/resampling/undersampling.json", 'w')
				...
				if count_y_1 < count_y_0:
					...
					if os.path.exists("ATLAS/paper_experiments/S1/resampling/resampling.json"):
						os.remove("ATLAS/paper_experiments/S1/resampling/resampling.json")
						
					resampling_out = open("ATLAS/paper_experiments/S1/resampling/resampling.json", 'w')
