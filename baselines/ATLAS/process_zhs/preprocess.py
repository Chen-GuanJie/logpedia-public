...
if __name__ == '__main__':
    scene='S1'
    input_file_name='ATLAS/raw_logs/'+scene+'/logs/'
    output_file_name='ATLAS/process_zhs/'+scene+'/'
    
    preprocessing_lines = []

    output_file =output_file_name+'process.csv'
    testing_wf = open(output_file, 'w')
    
    pp_dns(testing_wf, input_file_name)
    pp_http(testing_wf, input_file_name)
    pp_audit_w(testing_wf, input_file_name)
