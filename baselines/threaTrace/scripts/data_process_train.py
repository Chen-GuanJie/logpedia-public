...
def MyDataset(path, model):
	...
	f_train_feature = open('/Users/zhanghangsheng/Documents/my_code/llm_ids/threaTrace/models/feature.txt', 'w')
	for i in edgeType_map.keys():
		f_train_feature.write(str(i)+'\t'+str(edgeType_map[i])+'\n')
	f_train_feature.close()
	f_train_label = open('/Users/zhanghangsheng/Documents/my_code/llm_ids/threaTrace/models/label.txt', 'w')
